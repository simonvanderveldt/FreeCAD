...
def InitApplications():
	...
	for _, freecad_module_name, freecad_module_ispkg in pkgutil.iter_modules(freecad.__path__, "freecad."):
		if freecad_module_ispkg:
			...
			if any (module_name == 'InitGui' for _, module_name, _ in pkgutil.iter_modules(freecad_module.__path__)):
				try:
					importlib.import_module(freecad_module_name + '.InitGui')
				...
				Log('Init: No InitGui module found in ' + freecad_module_name + ', skipping\n')
